...
\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth]{matlab/tri_esq}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{matlab/tri_l1}
	\caption{Tensão na lampada 1 para retificador trifásico}
	\label{fig:tl1}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{matlab/tri_d1}
